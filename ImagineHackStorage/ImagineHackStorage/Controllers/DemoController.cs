...
namespace ImagineHackStorage.Controllers
{
    ...
    public class DemoController : ControllerBase
    {
        ...
        public async Task<IActionResult> BasicAzureTable()
        {
            ...
            var retrievedEntity = await StorageUtils.RetrieveEntityUsingPointQueryAsync(storageTable, "Black", "Jack");

            await StorageUtils.DeleteEntityAsync(storageTable, retrievedEntity);
            return Ok();
        }
